...
class QuestionRewrittingPydantic(QuestionAnalysisBasePydantic):
    ...
    question_type: str = Field(description="The type of the question as a string. One value in: ['salutations', 'fin_echange', 'autre']")#. One value in: ['greetings', 'ending', 'company', 'job', 'training', 'funding', 'other'].")